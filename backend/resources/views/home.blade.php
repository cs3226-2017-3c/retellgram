              ...
              <section class="post-body">
                ...
                <div class="panel panel-caption">
                  ...
                  <div class="row caption-new">  
                    <font color="white">Ruler faction refreshing in:    <h2 id="countdown"></h2>
                  </div>
                  <!-- <div class="row caption-new">
              ...
              <section class="post-footer">
                ...
                <div class="post-footer-option container">
                  <ul class="list-unstyled">
                    ...
                    <li class="tell-link"><a href="/tell?image_id={{$r->image->id}}"><i class="fa fa-bomb" aria-hidden="true"></i> Retell</a></li>
                    <li class="share-link"><a href="#" onclick=shareFB("{{env('APP_URL')}}","{{$r->image->id}}","{{$r->id}}")><i class="fa fa-facebook-official"></i> Share</a></li>
